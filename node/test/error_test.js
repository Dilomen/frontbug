...
describe('GET /errorRequest', function() {
  it('responds with json', function(done) {
    agent
      .get(`/errorRequest?error=${errorURLdata}`)
      .set('Accept', 'application/json')
      .expect(200)
      .end(function(err, res) {
        if (err) return done(err);
